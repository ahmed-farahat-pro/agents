    ...
    html: `
      <div style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: #ffffff; padding: 32px 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 12px 12px;">
          ...
          <p style="color: #333; font-size: 15px; line-height: 1.6;">Thank you for subscribing! Here are your requested roadmaps:</p>
          
          <div style="background: rgba(255, 87, 10, 0.08); padding: 24px; border-radius: 12px; margin: 24px 0; border: 1px solid rgba(255, 87, 10, 0.2);">
            <h3 style="margin-top: 0; font-size: 12px; text-transform: uppercase; letter-spacing: 1px; color: #ff570a;">Your Roadmaps</h3>
            <p style="white-space: pre-line; margin: 0; color: #333;">${roadmapList}</p>
          </div>
          
          <p style="color: #333; margin-bottom: 12px;"><strong>Download your PDFs here:</strong></p>
          <ul style="color: #333;">
            ${roadmaps.map(r => `<li style="margin-bottom: 8px;"><a href="https://nigents.com/materials/${r}-roadmap.pdf" style="color: #ff570a; font-weight: 600;">${r.charAt(0).toUpperCase() + r.slice(1)} Roadmap</a></li>`).join('')}
          </ul>
          
          <p style="color: #333; font-size: 15px; line-height: 1.6;">These 30-day roadmaps will guide you step-by-step to become a professional developer.</p>
